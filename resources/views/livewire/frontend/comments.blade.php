    ...
    <div class="row">
        <div class="col-lg-8 col-md-12">
            <form class="form-contact comment_form" wire:submit.prevent="save" id="commentForm">
                <div class="row">
                    <div class="rating">
                        <input type="radio" id="star5" wire:model="rating" value="5" /><label for="star5"
                            title="5 stars"></label>
                        <input type="radio" id="star4" wire:model="rating" value="4" /><label for="star4"
                            title="4 stars"></label>
                        <input type="radio" id="star3" wire:model="rating" value="3" /><label for="star3"
                            title="3 stars"></label>
                        <input type="radio" id="star2" wire:model="rating" value="2" /><label for="star2"
                            title="2 stars"></label>
                        <input type="radio" id="star1" wire:model="rating" value="1" /><label for="star1"
                            title="1 star"></label>
                    </div>
                    <div class="col-12">
